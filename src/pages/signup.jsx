      ...
      <div className='min-h-screen bg-cover relative' style={{ backgroundImage: `url(${bckg})` }}>
         ...
         <div className='min-h-screen flex flex-col justify-center items-center'>
            {/* <div className='flex  justify-center mt-[10rem] mb-12'> */}
               <div className='bg-gray-900  rounded-md flex flex-col  items-center w-[25rem] md:w-[30rem] bg-opacity-65'>
                  <p className='mt-10 text-[2rem] text-white' >Sign Up</p>
                  <form className='mt-10   flex flex-col w-[20rem] gap-5' onSubmit={handleSubmit}>
                     ...
                     <div>
                        ...
                        {errors.profile_name && touched.profile_name ? <p className='text-[#f6bdbd] text-[15px] mt-2 ml-6'>{errors.profile_name}</p> : ""}
                     </div>
                     <div>
                        ...
                        {errors.email && touched.email ? <p className='text-[#f6bdbd] text-[15px] mt-2 ml-6'>{errors.email}</p> : ""}
                     </div>
                     ...
                     <div>
                        ...
                        {errors.password && touched.password ? <p className='text-[#f6bdbd] text-[15px] mt-2 ml-6'>{errors.password}</p> : ""}
                     </div>
                     ...
                     <div>
                        ...
                        {errors.confirmpassword && touched.confirmpassword ? <p className='text-[#f6bdbd] text-[15px] mt-2 ml-6'>{errors.confirmpassword}</p> : ""}
                     </div>

                     <button className='bg-stone-800 hover:bg-stone-950 py-3 rounded-3xl text-white' type="submit">Submit</button>
                  </form>
                  <p className='mt-6 pb-9  text-[1.3rem]'>Already Registered?<span className=' ml-3 inline-block transition transform hover:scale-125 hover:text-red-300'><Link to='/signin'>Signin</Link> </span></p>
               </div>
            {/* </div> */}
         </div>
         <Footer />
